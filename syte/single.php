	...
	<div class="wrap-header">
				...
				<div class="row">
					<div class="col-1-4">
						<span class="contact-info left">
							<b style="color:#2b2459;font-size:14px;">Работаем с пн по сб с 10 до 10</b>
							<br>
							Воскресение выходной
						</span>
					</div>
					<div class="col-2-4">
						<div id="logo"><a href="index.php"><H1>MOJAYA</H1></a></div>
					</div>
					<div class="col-1-4">
						<span class="contact-info right">
							<b style="color:#2b2459;font-size:14px;">Номер: 89611484152</b>
							<br>
							наш email: romanutadima5@gmail.com
						</span>
					</div>
				</div>
			</div>
		...
		<div id="cssmenu" >
			<ul>
			   ...
			   <li><a href="archive.php"><span>О нас</span></a></li>
			   <li><a href="single.php"><span>Услуги</span></a></li>
			</ul>
		</div>
		</header>
							...
							<div class="wrap-col">
								...
								<div class="wid-content">
									<div class="row">
										<div class="col-1-3">
											<div class="wrap-col">
												<a href="#"><img src="images/portfolio-2.jpg" /></a>
												<h4><a href="#">Aliquam erat volutpat nibh</a></h4>
											</div>
										</div>
										<div class="col-1-3">
											<div class="wrap-col">
												<a href="#"><img src="images/portfolio-3.jpg" /></a>
												<h4><a href="#">Aliquam erat volutpat nibh</a></h4>
											</div>
										</div>
										<div class="col-1-3">
											<div class="wrap-col">
												<a href="#"><img src="images/portfolio-4.jpg" /></a>
												<h4><a href="#">Aliquam erat volutpat nibh</a></h4>
											</div>
										</div>
									</div>
				...
				<div id="sidebar" class="col-1-3">
					<div class="wrap-sidebar">
						...
						<div class="widget wid-gallery">
							...
							<div class="wid-content">
								<a href="#"><img src="images/portfolio-1.jpg"></a>
								<a href="#"><img src="images/portfolio-2.jpg"></a>
								<a href="#"><img src="images/portfolio-3.jpg"></a>
								<a href="#"><img src="images/portfolio-4.jpg"></a>
								<a href="#"><img src="images/portfolio-1.jpg"></a>
		...
		<footer>
			...
			<div class="copyright">
				<div class="zerogrid wrapper">
					Copyright @ zHairSalon - Designed by <a href="https://www.zerotheme.com" title="free website templates">ZEROTHEME</a>
					<ul class="quick-link">
